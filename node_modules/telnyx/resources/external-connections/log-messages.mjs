...
import { DefaultPaginationForLogMessages, } from "../../core/pagination.mjs";
...
export class LogMessages extends APIResource {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/external_connections/log_messages', (DefaultPaginationForLogMessages), { query, ...options });
    }
    /**
...
//# sourceMappingURL=log-messages.mjs.map