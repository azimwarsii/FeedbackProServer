...
export interface Assistant {
     ...
     */
    tools?: Array<Assistant.BookAppointmentTool | Assistant.CheckAvailabilityTool | WebhookTool | HangupTool | TransferTool | Assistant.CallControlRetrievalTool>;
}
export declare namespace Assistant {
    ...
    interface CallControlRetrievalTool {
        retrieval: CallControlRetrievalTool.Retrieval;
        type: 'retrieval';
    }
    namespace CallControlRetrievalTool {
        interface Retrieval {
 ...
 * user.
 */
export type AssistantTool = InferenceEmbeddingWebhookToolParams | RetrievalTool | AssistantTool.Handoff | HangupTool | AssistantTool.Transfer | AssistantTool.Refer | AssistantTool.SendDtmf | AssistantTool.SendMessage | AssistantTool.SkipTurn;
