...
class Conferences extends resource_1.APIResource {
     ...
     */
    list(query = {}, options) {
        return this._client.getAPIList('/conferences', (pagination_1.DefaultFlatPagination), { query, ...options });
    }
    /**
    ...
    listParticipants(conferenceID, query = {}, options) {
        return this._client.getAPIList((0, path_1.path) `/conferences/${conferenceID}/participants`, (pagination_1.DefaultFlatPagination), { query, ...options });
    }
    /**
     ...
     * ```
     */
    retrieveParticipant(participantID, params, options) {
        const { id } = params;
        return this._client.get((0, path_1.path) `/conferences/${id}/participants/${participantID}`, options);
    }
    /**
     ...
     * ```
     */
    updateParticipant(participantID, params, options) {
        const { id, ...body } = params;
        return this._client.patch((0, path_1.path) `/conferences/${id}/participants/${participantID}`, { body, ...options });
    }
}
